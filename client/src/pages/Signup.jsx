...
function Signup() {
  ...
  const [isRepeatPasswordValid, setIsRepeatPasswordValid] =
    useState(false);
    ...
    <>
      {isFormValid ? (
        ...
        <div className="flex flex-row lg:h-screen">
          <div
            className="lg:w-[50%] md:w-[70%] md:mx-auto w-full md:h-screen
         flex flex-col md:px-20 px-12 py-8 justify-center text-center md:text-start gap-4"
          >
            ...
            <div className="flex flex-col items-center justify-between gap-4">
              <div className="flex gap-2">
                <input
                  type="checkbox"
                  className="accent-bgPlayerColorDark "
                  onClick={() => setIsRead(!isRead)}
                />
                <p className="text-sm text-textColorLight">
                  I've read and accept the{" "}
                  <span className="text-bgPlayerColorLight cursor-pointer font-bold">
                    Terms & Conditions
                  </span>
                </p>
              </div>
            ...
            <p className="flex md:flex-row flex-col gap-2 justify-center text-sm text-textColorLight ">
          ...
          <img
            src={require("../assets/cover-img3.png")}
            alt="cover-img"
            className="w-[50%] h-full object-cover hidden lg:block"
          />
        </div>
      )}
    </>
